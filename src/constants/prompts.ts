...
2. 첫 번째 슬라이드는 반드시 주제 소개 슬라이드로 만들어주세요:
   - 제목: 주어진 내용의 핵심 주제나 제목을 담은 간결한 문구
   - 내용: 전체 주제에 대한 개요, 목적, 또는 핵심 메시지 소개
3. 두 번째부터는 세부 내용을 다루는 슬라이드로 구성하세요
4. 각 슬라이드는 하나의 주요 아이디어에 집중하세요
5. 제목은 최대 15자 이하로 간결하고 임팩트 있게 작성하세요
6. 내용은 풍부하고 상세하게 작성하세요
7. 반드시 위의 형식을 정확히 따라주세요

예시 구성:
- 첫 번째 슬라이드: "[주제명]" + 전체 개요/목적/핵심 메시지
- 나머지 슬라이드: 세부 내용, 방법론, 사례, 결론 등
`;
};
